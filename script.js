...
const CATALOG = [
  ...
  { group: "PERIFÉRICOS", items: ["RFID", "ICARD PARA RFID", "IBUTTON", "TAG PARA IBUTTON", "ST20U SUTECH", "BUZZER", "RELÉ BLOQUEIO 12V 5P", "RELÉ BLOQUEIO 24V 5P", "SW101", "GIROFLEX", "PLUGS CAN"] },
